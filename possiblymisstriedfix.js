...
export default function Modal({ setShowModal }) {
    ...
    useEffect(() => {
        //console.log('Indoor Total:', indoorTotal);
        //console.log('Nature Total:', natureTotal);
        //console.log('City Total:', cityTotal);

        // You could also use this to determine the dominant class and do something with that information.
        max = Math.max(indoorTotal, natureTotal, cityTotal);
        /*if (max === indoorTotal) {
            console.log("Dominant: Indoor");
        } else if (max === natureTotal) {
            console.log("Dominant: Nature");
    ...
    }, [indoorTotal, natureTotal, cityTotal]);
